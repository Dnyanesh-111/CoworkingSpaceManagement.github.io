...
$pass = hash('sha256', $salt . $passw);
    $stmt = $conn->prepare("SELECT * FROM clients WHERE email='" .$_POST['email'] . "' and password = '".$pass."' and status='Activate'"); 
      $stmt->execute();
                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form">
                              <center> <img src="../img/logo2.png" style="height:auto; width: 190px;" alt="homepage" class="dark-logo">
</center><br>
