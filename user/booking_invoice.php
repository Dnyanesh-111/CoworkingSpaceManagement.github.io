...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM booking where client_id='".$_SESSION['id']."'"); 
    $stmt->execute();
  ...
  function Header()
    {
      ...
      $this->SetXY(85, 20);
       $this->Cell(100,10,'Booking Details',0,1);
        ...
        $this->cell(45,10,'Worksapce Name',1,0,'',true);
...
// $abc=$stmt->fetch(PDO::FETCH_ASSOC);
 ...
 // $xyz=$stmt3->fetch(PDO::FETCH_ASSOC);
      ...
      //echo "<pre>";print_r($stmt6);exit;
          ...
          $pdf->cell(45,10,$package['wname'],1,0);
          // $pdf->cell(10,5,$value['no_of_offices'],1,0);
          // $pdf->cell(10,5,$value['no_of_desk'],1,0);
          ...
          // $pdf->cell(40,5,$value['client_id'],1,0);
          // $pdf->cell(40,5,$value['workspace_id'],1,1); 
