                        ...
                        <div class="card p-30" style="background: #FF5370;">
                           <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <?php
                                    $stmt = $conn->prepare("SELECT Count(*) as cnt FROM booking where client_id='".$_SESSION['id']."'");
                                    $stmt->execute();
                    ...
                    <div class="col-md-3">
                        <div class="card p-30" style="background: #FFB64D;">
                          <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <?php
                                 $stmt = $conn->prepare("SELECT SUM(total) as total FROM booking where client_id='".$_SESSION['id']."'");
                                  $stmt->execute();
                            ...
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                 ...
                                 $stmt1 = $conn->prepare("SELECT SUM(insert_amount) as amt FROM booking join payment 
                                    ...
                                    where booking.client_id='".$_SESSION['id']."'");
