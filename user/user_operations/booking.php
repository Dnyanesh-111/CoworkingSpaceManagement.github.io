...
try {
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO booking (client_id, state_id, workspace_id, no_of_offices,no_of_desk,from_date,to_date,total_amount,adv_amount,total,tax,created_date)
            VALUES ('".$_SESSION['id']."','".$_POST['state_id']."', '".$workspace_id[0]."', '".$_POST['no_of_offices']."','".$_POST['no_of_desk']."','".$_POST['from_date']."','".$_POST['to_date']."','".$_POST['total_amount']."','".$_POST['adv_amount']."','".$_POST['total']."','".$_POST['tax']."', CURDATE())";
