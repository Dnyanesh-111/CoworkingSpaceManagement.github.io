...
try {
 ...
 $stmt1 = $conn->prepare("SELECT * FROM clients where id='".$result['client_id']."'"); 
    $stmt1->execute();

     $result1 = $stmt1->setFetchMode(PDO::FETCH_ASSOC); 

    $clients=$stmt1->fetch(PDO::FETCH_ASSOC);
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="operations/payment_operation.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                            <input type="text" class="form-control"  name=" name" value="<?php echo $clients['name'];?>"required readonly>
                                            </div>
                                        </div>
                                           <div class="form-group row">
