...
try {
    ...
    if (isset($_POST['submit'])) {
        $sql = "INSERT INTO stationary (sname,items,cinfo,erole)
            VALUES ('" . $_POST['sname'] . "','" . $_POST['items'] . "','" . $_POST['items'] . "')";
    ...
    if (isset($_POST['update'])) {
        $sql = "UPDATE stationary SET sname='".$_POST['sname']."', items='".$_POST['items']."', cinfo='".$_POST['cinfo']."',
