...
<?php } ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Client Details</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Client Details</a></li>
  ...
  ?>
                               ...
                               <a href="add_clients.php"><button type="button" class="btn btn-primary">Add Client</button></a>
