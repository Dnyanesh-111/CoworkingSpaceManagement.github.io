...
<?php
 ...
 try {
  ...
  if(isset($_GET['id']))
    {
      $id=$_GET['id'];
      $stmt = $conn->prepare("select * from clients where id='".$_GET['id']."'");
      $stmt->execute();
    ...
    $stmt9 = $conn->prepare("SELECT * FROM clients group by state_name"); 
    $stmt9->execute();
                      ...
                      <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                    ...
                                    <form action="operations/clients.php?edit_id=<?php echo $id;?>" method="post" enctype="multipart/form-data" >
                                    <div class="form-body">
