              ...
              <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    ...
                    <th style="width:10px">Workspace Name</th>
                    <th style="width:10px">office</th>
                    <th style="width:10px">Desk</th>
                ...
                <tbody>
                  ...
                  try {
                    ...
                    foreach ($data as $value) {
                      ...
                      $workspace = $stmt2->fetch(PDO::FETCH_ASSOC);
                  ...
                  ?>
                      <tr>
                        ...
                        <td style="width:10px"><?php echo $workspace['city']; ?></td>
                        <td style="width:10px"><?php echo $workspace['wname']; ?></td>
                        <td style="width:10px"><?php echo $value['no_of_offices']; ?></td>
                        <td style="width:10px"><?php echo $value['no_of_desk']; ?></td>
