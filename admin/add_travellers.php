...
<div class="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <form action="operations/clients.php" method="post" id="loginForm" enctype="multipart/form-data">
                            <div class="form-body">
 ...
 for any PHP, Codeignitor or Laravel work contact me at mayuri.infospace@gmail.com  -->
                                ...
                                <a href="add_clients.php"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
                        </form>
                    </div>
                </div>
