        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Payment Details</h3> </div>
...
$abc = $stmt3->setFetchMode(PDO::FETCH_ASSOC); 
    $payment=$stmt3->fetch(PDO::FETCH_ASSOC);
        ...
        <td><a href="operations/booking.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>

        <a href="update_booking.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>

        <a href="add_payment.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-success"><i class="fa fa-inr"></i></a>
