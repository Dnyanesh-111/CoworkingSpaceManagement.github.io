                ...
                <div class="row">
                        ...
                        <div class="card p-30"  style="background: #FF5370;">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <?php
                                    $stmt = $conn->prepare("SELECT Count(*) as cnt FROM workspaces");
                                    $stmt->execute();
                                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                    
                                     ?>
                                   <h2 style="color:white"><?php echo $result['cnt']; ?></h2>
                                    <p class="m-b-0" style="color:white">Total Workspaces</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card p-30" style="background: #28a745;">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-building f-s-40 color-white"></i></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <?php
                                    $stmt = $conn->prepare("SELECT Count(*) as cnt FROM clients");
                                    $stmt->execute();
                                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                    
                                     ?>
                                    <h2 style="color:white"><?php echo $result['cnt']; ?></h2>
                                    <p class="m-b-0" style="color:white">Total Cities</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    ...
                                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                     ...
                                     ?>
                                    <h2 style="color:white"><?php echo $result['cnt']; ?></h2>
                                    <p class="m-b-0" style="color:white">Total Clients</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:10px">Worksapce Name</th>
...
try {
    ...
    $data=$stmt->fetchAll();
                                                ...
                                                foreach ($data as $value) {
 $stmt1 = $conn->prepare("SELECT * FROM clients where id='".$value['client_id']."'");
...
$abc = $stmt1->setFetchMode(PDO::FETCH_ASSOC); 
 ...
 $stmt2 = $conn->prepare("SELECT * FROM workspaces where id='".$value['workspace_id']."'");
$stmt2->execute();
$abc = $stmt2->setFetchMode(PDO::FETCH_ASSOC);  
     ...
     $currency=$stmt1->fetch(PDO::FETCH_ASSOC);
                                          ?>
                                           <tr>
                                                ...
                                                <td style="width:10px"><?php echo $package['wname'];?></td>
...
$stmt1 = $conn->prepare("SELECT * FROM clients where id='".$booking['client_id']."'");
...
$abc = $stmt1->setFetchMode(PDO::FETCH_ASSOC); 
 ...
 $stmt2 = $conn->prepare("SELECT * FROM workspaces where id='".$booking['workspace_id']."'");
$stmt2->execute();
$abc = $stmt2->setFetchMode(PDO::FETCH_ASSOC);  
    $package=$stmt2->fetch(PDO::FETCH_ASSOC);
