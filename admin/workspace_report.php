        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Workspace Report</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Workspace Report</a></li>
...
try {
    ...
    $stmt = $conn->prepare("SELECT id, wname,addr,city,descrp,price_per_office,price_per_desk FROM workspaces"); 
    $stmt->execute();
...
<!-- 
    ...
    <a href="update_workspaces.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil fa-2x" data-toggle="tooltip" title="Edit"></i></a></td>    -->
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
       <?php echo "<script>
  setTimeout(\"location.href='workspace_report.php'\", 2000);
